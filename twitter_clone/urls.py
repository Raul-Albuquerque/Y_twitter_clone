...
from .views import home_view, like_tweet_view, signup_view, signin_view, feed_tweets_view, feed_profile_view, logout_view, delete_tweet_view, follow_view, unfollow_view, test_view
...
urlpatterns = [
    ...
    path("teste/", test_view.teste, name="teste")
]
